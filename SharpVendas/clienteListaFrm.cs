...
{
    public partial class clienteListaFrm : Form
    {
        public clienteListaFrm()
        {
            InitializeComponent();
        ...
        {
            dgvDadosClientes.DataSource = null;
            DAOcliente q = new DAOcliente();
            dgvDadosClientes.DataSource = q.listaTodosVendedoresLike(txtFiltrar.Text);
        }
    }
}
